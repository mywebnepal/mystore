        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    {{ Form::hidden('hiddenUrl', url()->current()) }}
                    <fieldset>
                        <legend>Login</legend>
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="your email address" required autofocus>
