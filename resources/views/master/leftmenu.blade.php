			...
			<nav style="margin-top: -3em;">
				<ul>
					...
					<li class="top-menu-invisible">
						...
						<ul>
							<li class="">
								<a href="layouts.html" title="Dashboard"><i class="fa fa-lg fa-fw fa-gear"></i> <span class="menu-item-parent">Admission Form</span></a>
							</li>
							<li class="">
								{{ HTML::link('/student', 'Student Enroll', array('title' => 'Student Details', 'class'=>'menu-item-parent'))}}
							</li>
							<!-- <li>
					...
					<li>
						<a href="#"><i class="fa fa-lg fa-fw fa-table"></i> <span class="menu-item-parent">E-setting</span></a>
						<ul>
							<li>
					...
					<li>
						<a href="#"><i class="fa fa-lg fa-fw fa-shopping-cart"></i> <span class="menu-item-parent">Assets</span></a>
						<ul>
					...
					<li>
						<a href="#"><i class="fa fa-lg fa-fw fa-windows"></i> <span class="menu-item-parent">Transportation</span></a>
						<ul>
							<li>
					...
					<li class="chat-users top-menu-invisible">
						<a href="#"><i class="fa fa-lg fa-fw fa-comment-o"><em class="bg-color-pink flash animated">!</em></i> <span class="menu-item-parent">Reception</span></a>
						<ul>
							<li>
								<!-- DISPLAY USERS -->
